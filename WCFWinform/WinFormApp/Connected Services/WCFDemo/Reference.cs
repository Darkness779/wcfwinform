...
namespace WinFormApp.WCFDemo {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="Student", Namespace="http://schemas.datacontract.org/2004/07/WCFWinform")]
    ...
    public interface IWCFServiceDemo {
        ...
        WinFormApp.WCFDemo.Student[] GetStudents();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFServiceDemo/GetStudents", ReplyAction="http://tempuri.org/IWCFServiceDemo/GetStudentsResponse")]
        System.Threading.Tasks.Task<WinFormApp.WCFDemo.Student[]> GetStudentsAsync();
        ...
        bool AddStudent(WinFormApp.WCFDemo.Student newStudent);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFServiceDemo/AddStudent", ReplyAction="http://tempuri.org/IWCFServiceDemo/AddStudentResponse")]
        System.Threading.Tasks.Task<bool> AddStudentAsync(WinFormApp.WCFDemo.Student newStudent);
        ...
        bool UpdateStudent([System.ServiceModel.MessageParameterAttribute(Name="updateStudent")] WinFormApp.WCFDemo.Student updateStudent1);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFServiceDemo/UpdateStudent", ReplyAction="http://tempuri.org/IWCFServiceDemo/UpdateStudentResponse")]
        System.Threading.Tasks.Task<bool> UpdateStudentAsync(WinFormApp.WCFDemo.Student updateStudent);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IWCFServiceDemoChannel : WinFormApp.WCFDemo.IWCFServiceDemo, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WCFServiceDemoClient : System.ServiceModel.ClientBase<WinFormApp.WCFDemo.IWCFServiceDemo>, WinFormApp.WCFDemo.IWCFServiceDemo {
        ...
        public WinFormApp.WCFDemo.Student[] GetStudents() {
            return base.Channel.GetStudents();
        }
        
        public System.Threading.Tasks.Task<WinFormApp.WCFDemo.Student[]> GetStudentsAsync() {
            return base.Channel.GetStudentsAsync();
        }
        
        public bool AddStudent(WinFormApp.WCFDemo.Student newStudent) {
            return base.Channel.AddStudent(newStudent);
        }
        
        public System.Threading.Tasks.Task<bool> AddStudentAsync(WinFormApp.WCFDemo.Student newStudent) {
            return base.Channel.AddStudentAsync(newStudent);
        }
        
        public bool UpdateStudent(WinFormApp.WCFDemo.Student updateStudent1) {
            return base.Channel.UpdateStudent(updateStudent1);
        }
        
        public System.Threading.Tasks.Task<bool> UpdateStudentAsync(WinFormApp.WCFDemo.Student updateStudent) {
